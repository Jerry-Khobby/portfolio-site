...
const AboutComponent = () => {
  return (  
    <div className='h-full  px-4 sm:px-4 lg:px-48 md:36 flex flex-col items-start sm:items-start sm:justify-start pb-10 sm:mt-14 md:mt-10 lg:mt-0 mt-14'>
           <div>
        <h4 style={{fontFamily: 'Fira Code'}} className='text-2xl text-white font-bold sm:text-2xl md:text-4xl lg:text-5xl'>About </h4>
      </div>
      <div>
        {/** descriptions */}
      <p className='text-white text-sm mt-5  text-bold' style={{fontFamily:'Fira Code'}}>
